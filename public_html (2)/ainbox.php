            ...
            <div class="form-box login">
                ...
                <b style="font-size: 30px;"> <a href="checkapproved.php" class="" style="color:white">Check Approved
                    ...
                    <a href="leaveextension.php" class="" style="color:white">Leave Extension
                        ...
                        |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="dutyleave.php" class="" style="color:white">Duty Leave
                        </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br>
...
<tbody>
                ...
                if ($con) {
                    if ($_SESSION['mentor'] == "mentor1@gmail.com") {
                        $rs = mysqli_query($con, "select * from medical where Id<=15");
                        ...
                        <td>
                         <a  href="pdf/<?php echo $r['filename'];?>" download="pdf/<?php echo $r['filename'];?>">           <?php echo $r['filename']; ?></a>
                        </td>
